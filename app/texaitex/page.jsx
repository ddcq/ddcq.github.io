  ...
  return (
    <div className="hero">
      <article className="prose hero-content  flex-col">
        <img src="img/expertassurance.jpg" />
        ...
        <div>
          <h2>
            iTex
            <br />
            <small>Gestionnaire de sinistres et de prestation d'expertise</small>
          </h2>
          <h5>Developpeur Fullstack JEE/AngularJS | Technical Leader (Janvier 2016)</h5>
          ...
          <h2>
            Nouveau Texi Mobile
            <br />
            <small>Logiciel d'expertise sur site</small>
          </h2>
          <h5>Developpeur Fullstack JavaScript | Technical Leader</h5>
          <hr className="star-primary" />
          <dl>
            <dt>Taches</dt>
            <dd>

...
export default function ThemeSelector() {
  ...
  return (
    <div>
      <div className="flex flex-col w-screen gap-vw-10-min@sm-max@2xl m-vw-7">
        {themes.map(([mode, themesByMode]) => (
          <>
            ...
            <div className="rounded-box grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
              {themesByMode.map(([id]) => (
                <div data-theme={id} className="bg-base-100 text-base-content w-full cursor-pointer" onClick={() => saveTheme(id)}>
